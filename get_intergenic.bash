...
cat - $bed_gff | bedtools sort -i stdin >  $all_bed_stranded #combine intergenic regions with original file

### Perform Bedtools complement but without any stranded information ###
bedtools complement -i $bed_gff -g $gfile | 
